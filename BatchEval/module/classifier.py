...
from BatchEval.module import MultiCEFocalLoss, DnnDataset, EarlyStopping
...
class BatchClassifier:
    def __init__(self, input_dims, n_batch, data_x, batch_idx, batch_size=4096, gpu="0"):
        self.set_seed()
    ...
    def convert_loader(self, data, batch_idx, batch_size):
